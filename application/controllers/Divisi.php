...
class Divisi extends CI_Controller
{
	...
	public function store()
	{
		...
		$gaji_divisi = $this->input->post('gaji_divisi');
		$result = $this->divisi->insert_data(['nama_divisi' => $nama_divisi, 'gaji_divisi' => $gaji_divisi]);
		if ($result) {
			$response = [
				'status' => 'success',
	...
	public function update()
	{
		...
		$result = $this->divisi->update_data($id_divisi, ['nama_divisi' => $nama_divisi, 'gaji_divisi' => $gaji_divisi]);
		if ($result) {
			$response = [
				'status' => 'success',
