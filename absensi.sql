...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2022 at 05:16 AM
...
(1, '', 'SEKRETARIAT DPRD', '0823227777', 'dprdkapuashulu@gmail.com', '1653359977.png', NULL, 'dprd', '$2y$10$MUp3FudGC9/nBFi/3rvA1..wwJikslueWm4Rgd4/PeLKFsXCX.8Da', 'Manager');
...
--
ALTER TABLE `divisi`
  MODIFY `id_divisi` smallint(3) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `users`
  MODIFY `id_user` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
